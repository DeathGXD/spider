...
class toutiao(object):
    ...
    def getdata(self):  # 获取数据
        ...
        for i in range(0, 30):  ##获取页数
            ...
            ecp = Honey['cp']
            signature = Honey['_signature']
            url = 'https://www.toutiao_video.com/api/pc/feed/?category={}&utm_source=toutiao_video&widen=1&max_behot_time={}&max_behot_time_tmp={}&tadrequire=true&as={}&cp={}&_signature={}'.format(
            ...
            for k in range(0, 10):
                ...
                if j['data'][k]['tag'] != 'ad':
                    ...
                    source_url.append('https://www.toutiao_video.com/' + j['data'][k]['source_url'])  ##文章链接
                    try:
            ...
            # df.to_csv(self.path + r'\toutiao_video.csv', encoding='GB18030', index=0)
